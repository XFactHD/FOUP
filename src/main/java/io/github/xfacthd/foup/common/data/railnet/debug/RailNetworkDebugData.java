...
public record RailNetworkDebugData(List<Node> nodes) {
    ...
    public record Node(BlockPos pos, Optional<String> stationName, Optional<StationType> stationType, boolean occupied, List<BlockPos> neighbours) {
        private static final StreamCodec<ByteBuf, Node> STREAM_CODEC = StreamCodec.composite(
                BlockPos.STREAM_CODEC,
                Node::pos,
                ByteBufCodecs.optional(ByteBufCodecs.STRING_UTF8),
                Node::stationName,
                ByteBufCodecs.optional(StationType.STREAM_CODEC),
                Node::stationType,
                ByteBufCodecs.BOOL,
                Node::occupied,
