...
public final class TrackPath {
    ...
    public @Nullable TrackNode peek(RailNetwork network) {
    ...
    public @Nullable TrackNode remove(RailNetwork network) {
    ...
    static final class PathNode {
        ...
        private @Nullable TrackNode getNode(RailNetwork network) {
            if (node == null) {
